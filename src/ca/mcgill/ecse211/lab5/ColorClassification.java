...
/**
 * This class allows the identification of the color of a 222 mL can. The can can either be blue, red, green or yellow.
 * @author Floria Peng
 *
 */
public class ColorClassification implements Runnable {
	...
	/* CONSTANTS */
	/**
	 * The normalized mean value for each color. 
	 * The values were found after taking 100 sample point for each color, normalizing them and taking the average of these normalized values.
	 * The first number in the array is the R component value.
	 * The second number in the array is the G component value.
	 * The third number in the array is the B component value.
	 */
	...
	/**
	 * The normalized standard deviation value for each color. 
	 * The values were found after taking 100 sample point for each color, normalizing them and taking the standard deviation of these normalized values.
	 * The first number in the array is the R component value.
	 * The second number in the array is the G component value.
	 * The third number in the array is the B component value.
	 */
	...
	public void run() {
		...
		while (true) {
			...
			/**
			 * If a color is detected, then you increase the array at the corresponding value.
			 * Number 1 detects blue color and increases detected at position 0.
			 * Number 2 detects green color and increases detected at position 1.
			 * Number 3 detects yellow color and increases detected at position 2.
			 * Number 4 detects red color and increases detected at position 3.
			 */
			if (colorDetect(1)) {
				detected[0]++;
	...
	boolean colorDetect(int colorID) {
		...
		//Depending on the colorID, this switch statements correctly sets the target mean and standard deviation value.
		switch (colorID) {
		case 1:
		...
		//If the reading value is within 3 standard deviations from the target mean for the 3 components, then return that color is identified.
	...
	/**
	 * The mean filter to guess the correct color.
	 * Window size is set to 5
